...
.sms-compose textarea{display:block;width:100%;min-height:128px;padding:12px 13px;border:1px solid var(--line);border-radius:10px;background:#fbfbfd;color:var(--text);outline:none;resize:vertical;font:inherit;line-height:1.65}.sms-compose textarea::placeholder{color:#8e8e93}.sms-compose textarea:focus{border-color:#8e8e93;box-shadow:0 0 0 3px #8e8e9324}.compose-meta{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-top:6px;color:var(--muted);font-size:.84rem;line-height:1.45}.compose-hint{min-width:0}.send-status{align-self:center;margin:0}.sms-compose .actions button{min-width:108px}html[data-theme="dark"] .sms-compose textarea{background:#2c2c2e}
