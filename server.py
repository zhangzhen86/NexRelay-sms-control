...
.column-sort{display:inline-flex;align-items:center;gap:4px;min-height:0;padding:0;border:0;border-radius:0;background:transparent!important;color:inherit!important;box-shadow:none!important;font:inherit;font-weight:inherit;line-height:inherit;white-space:nowrap}.column-sort:hover{background:transparent!important}.column-sort:hover .sort-label{text-decoration:underline;text-underline-offset:3px}.sort-arrow{display:inline-block;min-width:.8em;color:var(--muted);font-size:.78em;line-height:1}.column-sort.active .sort-arrow{color:var(--text)}html{font-size:16px}@media(max-width:800px){html{font-size:15px}}
</style></head><body>
